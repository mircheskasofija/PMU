...
public class ViewGuideVisits extends AppCompatActivity {
    DatabaseReference databaseReference;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_guide_visits);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    if(user.equals(ds.child("user").getValue(String.class))){
                        ...
                        detailsButton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent intent = new Intent(getApplicationContext(), GuideVisitDetails.class);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ViewGuideVisits.this, "Неуспешно!", Toast.LENGTH_SHORT).show();
            }
        });
